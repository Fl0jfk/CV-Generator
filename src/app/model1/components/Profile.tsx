...
function Profile (){
    ...
    return (
        <section className="w-full h-[35%] flex flex-col gap-3">
            <h2 className="text-xl">{infoProfile.firstname}</h2>
            <h2 className="text-xl">{infoProfile.lastname}</h2>
            <p>{infoProfile.profession}</p>
            <Image src={infoProfile.memoji} width={150} height={150} alt="Photo de profil" className="rounded-full"/>
